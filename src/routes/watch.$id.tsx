  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 mx-auto max-w-5xl w-full px-4 py-8">
        <Link to="/watch" className="text-sm text-muted-foreground hover:text-foreground">← All live games</Link>
        {!game ? (
          ...
          <div className="mt-6 grid lg:grid-cols-[auto_1fr] gap-8 items-start">
            <SnakeBoard state={game} size={480} className="rounded-xl border border-border shadow-lg" />
            <aside className="w-full max-w-sm space-y-4">
              ...
              <div className="rounded-xl border border-border bg-card p-5">
                ...
                <div className="mt-3 flex items-center gap-2 text-sm">
                  <span className={`size-2 rounded-full ${game.alive ? "bg-emerald-500 animate-pulse" : "bg-rose-500"}`} />
